...
os.environ["CUDA_VISIBLE_DEVICES"] = "2"  # Set to -1 for CPU
...
def main(video_path, alert_folder):
    ...
    if camera_misalignment_flag:
        ...
        # Open video
        # video_path = f"/data1/yasir/Data/Abnormal Behaviour3/Covering his face with the hand/Covering his face with the hand {0}.mp4"
        # cap = cv2.VideoCapture(video_path)
        prevboxA = None
